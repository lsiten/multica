  ...
  try{
    ...
    for(;;){
      ...
      for(const [index,peer]of peers.entries()){
        ...
        Object.assign(viewer,{receiveOfferEvidence:batch.receiveOfferEvidence,negotiated:batch.negotiated,observedDurationMs:batch.observedDurationMs,renderedFrames:batch.renderedFrames,uniqueDynamicFrames:batch.uniqueDynamicFrames,decodedFrames:batch.decodedFrames,invalidMarkers:batch.invalidMarkers,staleSourceFrames:batch.staleSourceFrames});
