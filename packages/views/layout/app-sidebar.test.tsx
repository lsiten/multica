...
const { appForeground, chatSessions, chatStore, detail, deletePin, invitationApi, navigation, pins, runtimes, runtimeQuery, sidebarState, summary, workspaces } = vi.hoisted(() => ({
