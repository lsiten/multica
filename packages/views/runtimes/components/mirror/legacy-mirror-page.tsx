...
} from "./mirror-page-state";
import { mirrorStateCopy } from "./mirror-state-copy";
...
export function LegacyRuntimeMirrorPage({
  runtimeId,
  connectionState,
  scope,
  ...
  const canReadRuntime = runtime && currentUserId
        ...
        <div className={cn(PAGE_RAIL, PAGE_GUTTER, "py-6")}>
          <div className="mx-auto w-full max-w-5xl space-y-5">
            <div>
              ...
              <h1 className="mt-1 text-title-sm font-semibold [overflow-wrap:anywhere]">{runtimeName}</h1>
