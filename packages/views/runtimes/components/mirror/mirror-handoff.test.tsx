...
import type { VscreenLocalOperation } from "@multica/core/types";
...
function render(localControl?: (_scope:typeof scope,op:VscreenLocalOperation)=>Promise<{ok:boolean;local:boolean;reason?:string}>){
